...
||||||| parent of 65cb93c (chore: Do not S-Space as toggle key)
  # See https://discourse.nixos.org/t/partly-overriding-a-desktop-entry/20743
  # And https://github.com/nix-community/home-manager/issues/3126
  xdg.desktopEntries = {
    "com.google.chrome" = {
      name = "Google Chrome";
...
=======
  ...
  xdg.desktopEntries = {
    "com.google.chrome" = {
      ...
      categories = [ "Application" "Network" "WebBrowser" ];
      mimeType = [ "text/html" "text/xml" ];
>>>>>>> 65cb93c (chore: Do not S-Space as toggle key)
    };
<<<<<<< HEAD
  } else
    { });
